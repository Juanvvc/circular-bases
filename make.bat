...
%OPENSCAD% -D base_texture=4 -D base_w=25 -o output\base_25mm_plates.png -q --autocenter circular_base.scad
%OPENSCAD% -D base_texture=4 -D base_w=25 -o output\base_25mm_plates.stl -q --export-format binstl circular_base.scad
